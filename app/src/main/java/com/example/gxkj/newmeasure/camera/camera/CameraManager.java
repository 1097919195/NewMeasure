...
import com.example.gxkj.newmeasure.camera.camera.open.OpenCameraInterface;
...
//            Log.e(TAG, "Resetting to saved camera params: " + parametersFlattened);
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            //attention 产生一个正方形扫描框
            int leftOffset = (screenResolution.x - min) / 2;
            int topOffset = (screenResolution.y - min) / 2; //attention 扫描框垂直方向位置
